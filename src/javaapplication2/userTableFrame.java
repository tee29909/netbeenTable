...
public class userTableFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        userScollPane = new javax.swing.JScrollPane();
        ...
        userScollPane.setViewportView(userTable);

        showUserButton.setText("jButton1");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(userScollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(userScollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE)
    ...
    private javax.swing.JScrollPane userScollPane;
    private javax.swing.JTable userTable;
    // End of variables declaration//GEN-END:variables

    private void showUserDetail() {
        System.out.println(userTable.getModel().getValueAt(userTable.getSelectedRow(), 1));
        String usernmae = userTable.getModel().getValueAt(userTable.getSelectedRow(), 1).toString();
        openUserDetall(usernmae);
    }

    private void openUserDetall(String usernmae) {
        this.setVisible(false);
        this.dispose();
        userDetailFrame fram = new userDetailFrame();
        fram.setUserName(usernmae);
